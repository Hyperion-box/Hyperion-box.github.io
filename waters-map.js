...
function drawLine(cell1, cell2) {
    ...
    let weeks = lineLength / 20; 

    // Create the label
    let label = document.createElement('span');
    label.textContent = `${weeks.toFixed(2)} days`; // Use toFixed(2) to round to 2 decimal places
